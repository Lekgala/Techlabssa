...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [settings, setSettings] = useState<AcademySettings>(() => {
    const defaults: AcademySettings = {
      ...
      admissionsAcknowledgement: 'Thank you for applying. Admissions will review your application and contact you with the next steps.',
      paymentInstructions: 'Use your invoice number as the payment reference. Upload proof of payment after making an EFT.',
      whatsappGreeting: 'Hi TechLabs Academy, I would like to ask about the IT Support bootcamp.',
      applicationsEnabled: true,
      onlinePaymentsEnabled: false,
      showPricing: true,
      showUpcomingCohorts: true,
